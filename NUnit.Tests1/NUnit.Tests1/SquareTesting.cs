...
namespace NUnit.SquareTesting
{
    ...
    public class TestClass
    {
        ...
        {
            System.Console.WriteLine("Start Square test suite");
        }

        [TestFixtureTearDown]
        public void TestFixtureTearDown()
        {
            System.Console.WriteLine("End Square test suite");
        }
        ...
        public void getLengthSquare(int x) // perimeter
        {
            Square positiveLength = new Square(x);
